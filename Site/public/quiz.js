...
const ver_resultado = document.querySelector(".buttons .resultado")
...
function computarResultado() {
    ...
    // Defina userScore aqui ou passe como argumento
    var vitoria;

    
  
    console.log('o id do usuario: ' + idUsuario);
    ...
    // Defina pontos aqui ou passe como argumento
    var corpo = {
      vitoria: vitoria,
      pontos: pontos,
      fkUsuario: idUsuario,
